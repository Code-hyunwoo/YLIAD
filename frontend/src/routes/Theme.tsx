...
function Theme() {
  ...
  function changeModak() {
    ...
    axios
      .patch(
        `https://k6a308.p.ssafy.io/user-service/api/users/theme/${userid}`,
        {
          themeName: "modak",
        },
        {
          ...
          <div className={styles.P_container2}>
            ...
            <div id={styles.themebox}>
              <div id={styles.themebox1}>
                <button onClick={changeModak} id={styles.btn2_P}>
                  {" "}
                  모닥불
                </button>
              ...
              <div id={styles.themebox2}>
                <button onClick={changeBandi} id={styles.btn2_P}>
                  {" "}
                  반딧불
                </button>
              ...
              <div id={styles.themebox3}>
                <button onClick={changeSuper} id={styles.btn2_P}>
                  {" "}
                  슈퍼맨
                </button>
        ...
        <div className={styles.M_container2}>
          ...
          <div id={styles.themeboxM}>
            <div id={styles.themebox1M}>
              <button onClick={changeModak} id={styles.btn2_M}>
                {" "}
                모닥불
              </button>
            ...
            <div id={styles.themebox2M}>
              <button onClick={changeBandi} id={styles.btn2_M}>
                {" "}
                반딧불
              </button>
            ...
            <div id={styles.themebox3M}>
              <button onClick={changeSuper} id={styles.btn2_M}>
                {" "}
                슈퍼맨
              </button>
