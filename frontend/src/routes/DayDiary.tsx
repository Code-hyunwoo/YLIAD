...
function DayDiary() {
  const [content, setContent] = useState(
    "오늘의 일기를 써보도록 하자. 오늘은 너무나도 즐겁고 행복한 하루였다. 모든게 힘들고 짜증나며, 포기하고 싶어진다."
  );
    ...
    <>
      ...
      <BrowserView>
        <div className={base.container}>
          <div id={styles.date} style={{ fontFamily: `${fontstyle}` }}>
            {" "}
            {date}
          </div>
          <div
          ...
          <button id={styles.btn1_P2} onClick={analyzeSentiment}>
            {" "}
            감정분석{" "}
          </button>
          <img
      ...
      <MobileView>
        <div className={base.container}>
          <div id={styles.dateM} style={{ fontFamily: `${fontstyle}` }}>
            {" "}
            {date}
          </div>
          <div
          ...
          <button id={styles.btn1_M2} onClick={analyzeSentiment}>
            {" "}
            감정분석{" "}
          </button>
