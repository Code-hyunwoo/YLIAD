...
function InfoChange() {
  ...
  function onsubmitNick() {
    if (userNickname === "") {
      ...
      axios
        .patch(
          `https://k6a308.p.ssafy.io/user-service/api/users/nickname/update/${userid}`,
          {
  ...
  function onsubmitPassword() {
    if (NewPassword === "") {
      ...
      axios
        .patch(
          `https://k6a308.p.ssafy.io/user-service/api/users/password/update/${userid}`,
          {
          ...
          <div className={styles.P_container2}>
            ...
            <p id={styles.info_box}>
              ...
              <input
                ...
                placeholder="닉네임"
              />
              <button onClick={onsubmitNick} id={styles.btn2_P2}>
                {" "}
                변경하기{" "}
              </button>
            </p>
            <p id={styles.info_box}>
              ...
              <input
                ...
                placeholder="비밀번호"
              />
              <button onClick={onsubmitPassword} id={styles.btn2_P2}>
                {" "}
                변경하기{" "}
              </button>
              <br />
            ...
            <Link to="/setting">
              <button id={styles.btn1_P2}> 돌아가기 </button>
            </Link>
          </div>
        </div>
      </BrowserView>
        ...
        <div className={styles.M_container2}>
          ...
          <div id={styles.info_box_M}>
            ...
            <input
              ...
              placeholder="닉네임"
            />
            <button onClick={onsubmitNick} id={styles.btn2_M2}>
              {" "}
              변경하기{" "}
            </button>
          </div>
          <div id={styles.info_box_M}>
            ...
            <input
              ...
              placeholder="비밀번호"
            />
            <button onClick={onsubmitPassword} id={styles.btn2_M3}>
              {" "}
              변경하기{" "}
            </button>
            <br />
